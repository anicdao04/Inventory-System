...
<head>
  ...
  <title>List of Tasks | IIMMS</title>
                            ...
                            <tbody>
                              @foreach($tasks as $data)
                                <tr>
                                    <td>{{$data->name}}</td>
                                    <td>
                                      <a class="btn btn-sm btn-default mr-1" href="{{url('admin/task/modify/'. $data->id)}}">Modify</a>
...
@if(Session::has('task_created'))
    <script>
        toastr.success("{!! Session::get('task_created') !!}");
    </script>
@elseif(Session::has('task_updated'))
    <script>
        toastr.info("{!! Session::get('task_updated') !!}");
    </script>
@endif
