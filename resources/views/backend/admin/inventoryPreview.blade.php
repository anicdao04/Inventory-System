                                ...
                                <div class="row"> <!-- start row -->
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$inventory->assign_id}}" class="form-control" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <span for="class" class="text-muted">Designation</span>
                                            <input type="text" value="{{$inventory->designation_id}}" class="form-control" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <span for="class" class="text-muted">Warranty</span>
                                            <input type="text" value="{{$inventory->warranty}}" class="form-control" disabled>
                                        </div>
                                    </div>
                                    <!-- <div class="col-md-6">
                                        <div class="form-group">
                                            <span for="class" class="text-muted">Item Name</span>
                                            <input type="text" value="{{$inventory->item_name}}" class="form-control" disabled>
                                        </div>
                                    </div> -->
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <span for="class" class="text-muted">Category</span>
                                            <input type="text" value="{{$inventory->category_id}}" class="form-control" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$inventory->date_purchased}}" class="form-control" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
