...
<head>
  ...
  <title>Modify Designation | IIMMS</title>
...
<div class="content-wrapper pt-4">
    <div class="container-fluid mt-3 px-5">
        <div class="mb-3">
            ...
            <p class="text-muted">Designation | Modify</p>
        </div>

      
      <form action="{{url('admin/designation/update/'.$designation->id)}}" method="post">
      @csrf
      @method('PUT')
        <div class="row">
            <div class="col-12 col-md-12 mt-4 mb-5">
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="{{$designation->name}}" class="form-control" required>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a class="btn btn-default" href="{{route('designation.index')}}">Cancel</a>
                    </div>
            </div>
